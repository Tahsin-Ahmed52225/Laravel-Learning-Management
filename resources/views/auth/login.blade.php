                                        ...
                                        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <input id="Teacher_login_email"name="teacher_email" type="email" class="form-control" placeholder="Email" required>
                                ...
                                <div class="main_content_wrapper">
                                    <div class="card">
                                        ...
                                        <div class="modal fade" id="exampleModalCenter2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Log in as Student </h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                                </div>
                                                <form method="POST" action="{{ route("login_student") }}" id="Student_login">
                                                    @csrf
                                                <div class="modal-body">
                                                    <input id="Teacher_login_email"name="student_email" type="email" class="form-control" placeholder="Email" required>
                                                    <input id="Teacher_Login_password" name="student_password" type="password" class="form-control" placeholder="Password" required>
                                                </div>
                                        ...
                                        <div class="modal fade" id="exampleModalCenter3" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Create An Account</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="Stu_cleanUp()">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                                </div>
                                                <div class="modal-body">
                                                    <div id="Stu_error_msg">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6"> <input id="Stu_firstName" type="text" class="form-control" placeholder="First Name" required></div>
                                                        <div class="col-6"> <input id="Stu_lastName" type="text" class="form-control" placeholder="Last Name" required></div>
                                                    </div>

                                                    <input id="Stu_userName" type="text" class="form-control" placeholder="Username.." required>
                                                    <input id="Stu_email" type="email" class="form-control" placeholder="Email" required>
                                                    <input id="Stu_institution" type="text" class="form-control" placeholder="Institution" required>
                                                    <input id="Stu_password" type="password" class="form-control" placeholder="Password" required>
                                                    <input id="Stu_Confirm_Password" type="password" class="form-control" placeholder="Confirm Password" required>
                                                   </form>
                                                </div>
                                                <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" onclick="student_signUp()" >Create Your Account</button>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js"></script>
    {{-- Teacher ajax --}}
<script src="{{ asset('js/TeacherValidation.js') }}" ></script>
<script src="{{ asset('js/StudentValidation.js') }}" ></script>
