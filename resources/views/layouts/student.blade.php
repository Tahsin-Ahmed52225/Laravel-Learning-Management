                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-menu collapse" id="dashboard">
                                @foreach ( $courses as $item )
                                      <li><a href="../pages/student_single_class.html">{{ $item->Course_Name }}</a></li>
                                @endforeach

                            </ul>
                        </li>
                        <li>
                            <a href="../pages/student_all_class.html"><i class="fa fa-bookmark"></i> <span class="nav-label">All Classes</span> </a>
                        </li>
                    </ul>
                </div>
            </aside>
